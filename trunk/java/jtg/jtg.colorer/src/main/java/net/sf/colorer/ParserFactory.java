...
public class ParserFactory {
	...
	public Enumeration<String> enumerateHRDClasses() {
		checkActive();
	...
	public Enumeration<String> enumerateHRDInstances(String classID) {
		checkActive();
		return new HRDEnumeration(classID);
	}

	class HRDEnumeration implements Enumeration<String> {
		int		idx		= 0;
