...
public class HRCRegionsTreeView extends ViewPart implements IPropertyChangeListener {
	...
	public void propertyChange(PropertyChangeEvent event) {
		...
		try {
			regionMapper = ColorerPlugin.getDefaultPF().createStyledMapper(StyledRegion.HRD_RGB_CLASS,
...
class RegionContentProvider implements ITreeContentProvider {
	...
	Hashtable<Region, Vector<Region>>	children	= new Hashtable<Region, Vector<Region>>();
	...
	void addChild(Region parent, Region child) {
		Vector<Region> list = children.get(parent);
		if (list == null) {
	...
	public Object[] getChildren(Object parentElement) {
		Vector<Region> list = children.get(parentElement);
		if (list == null) {
			return null;
		} else {
			return list.toArray();
	...
	public boolean hasChildren(Object element) {
		Vector<Region> list = children.get(element);
		return list != null;
	}
}
