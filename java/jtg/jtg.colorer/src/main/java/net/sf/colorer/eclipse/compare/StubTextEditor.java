...
public class StubTextEditor implements IColorerEditorAdapter {
	...
	public BaseEditor getBaseEditor() {
		if (fBaseEditor == null) {
			...
			fBaseEditor = new CachedBaseEditor(ColorerPlugin.getDefaultPF(), new DocumentLineSource(fViewer.getDocument()));
	...
	public void handleAttachComplete() {
		...
		fTextColorer.setRegionMapper(hrd, ColorerPlugin.getDefault().getPreferenceStore()
